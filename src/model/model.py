...
class RenamingModel(nn.Module):
    ...
    def load(cls, model_path, use_cuda=False, new_config=None) -> 'RenamingModel':
        ...
        config['decoder']['vocab_file'] = 'data/vocab.bpe10000/vocab'
        config['data']['dev_file']      = 'data/preprocessed_data/dev.tar'
        config['data']['train_file']    = 'data/preprocessed_data/train-shard-*.tar'
        config['data']['vocab_file']    = 'data/vocab.bpe10000/vocab'
        config['encoder']['graph_encoder']['vocab_file'] = 'data/vocab.bpe10000/vocab'
        config['encoder']['seq_encoder']['vocab_file'] = 'data/vocab.bpe10000/vocab'
